...
import { Search, FileText, AlertTriangle, RefreshCw, ChevronLeft, ChevronRight, Loader2, Tag } from 'lucide-react'
            ...
            <tbody>
              {loading ? (
                ...
                paginated.map(doc => (
                  <tr
                    key={doc.workflow_id}
                    className={`data-table-row cursor-pointer ${selectedRow === doc.workflow_id || selected.has(doc.workflow_id) ? 'bg-accent' : ''}`}
                    onClick={() => {
