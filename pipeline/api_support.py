"""Shared collaborators for the document-pipeline HTTP routers.

This module owns lazy backend clients and application-service helpers. It does
not construct the FastAPI app or import route modules, which keeps it safe for
every router to depend on regardless of import order.
"""
